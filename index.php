...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body data-spy="scroll" data-target="#scrollspy">
        ...
        <div class="main_figur">
            ...
            <div class="preloader">
                <h2>Welcome to the new era of rentals</h2>
                    ...
                    <div class="row">
                        <div class="col-md-12 ">
                            ...
                            <div class="main_home text-center wow fadeInUp" data-wow-duration="700ms">
                                <h1>True Reviews. <br /> 
                                    For Tenants And Landlords Alike.</h1>
                            ...
                            <div class="main_about_area p-t-3">
                                <div class="head_title m-y-3  wow fadeInUp">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <h6 class="m-b-2">We are a small team of four develpers eager to 
                                                better the rental experience for all.  </h6>
                                            <p>
                                                ...
                                                would allow someone to rent from them. 
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="single_abt single_about m-y-3">
                                                ...
                                                <h3>Design</h3>
                                                <p>The design is simple and straight forward keeping it very user friendly</p>
                                        ...
                                        <div class="col-md-4">
                                            <div class="single_abt single_about m-y-3">
                                                ...
                                                <h3>Users</h3>
                                                <p>Users can decide if they would like to create an account as a landlord or a tenant on the site.</p>
                                        ...
                                        <div class="col-md-4">
                                            <div class="single_abt single_about m-y-3">
                                                ...
                                                <h3>Ratings</h3>
                                                <p>The rating system is utilized for the benefit of other users on making an informed decision.</p>
                            ...
                            <div class="main_portfolio_area">
                                <div class="head_title m-y-3 p-y-3 wow fadeInUp">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <h6>Listed below are some of the top rental properties in the 661 area with 
                                                beautiful views and amazing ammenaties that will allow for a great property 
                                                to rent and embrace the city of Bakersfield to its fullest.
                                                 </h6>
                                        </div>  
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="single_portfolio">
                                                        ...
                                                        <div class="single_portfolio_overlay">
                                                            <div class="icon_area text-center">
                                                                <a href="assets/images/pf11.jpg" class="gallery-img"><img src="assets/images/plus.png" alt="" /></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-4  col-xs-12">
                                            ...
                                            <div class="single_portfolio height_1">
                                                ...
                                                <div class="single_portfolio_overlay">
                                                    <div class="icon_area text-center">
                                                        <a href="assets/images/pf22.jpg" class="gallery-img"><img src="assets/images/plus.png" alt="" /></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3  col-xs-12">
                                            <div class="single_portfolio height_1">
                                                ...
                                                <div class="single_portfolio_overlay">
                                                    <div class="icon_area text-center">
                                                        <a href="assets/images/pf31.jpg" class="gallery-img"><img src="assets/images/plus.png" alt="" /></a>
                                                    </div>
                                                </div>
                                            </div> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <h6>Rate em is a locally created real estate software focused on creating
                                                ...
                                                of being a renter or renting out your home. </h6>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="col-md-8">
                                                    <div class="copyright_text margin-top-20 center">
                                                        <p class=" wow fadeInRight animated" data-wow-duration="1s">Made with <i class="fa fa-heart"></i>
                                                            by <a target="_blank" href="https://bootstrapthemes.co">Bootstrap Themes</a> 2016. All Rights Reserved</p>
                                                    </div>
                                                </div>
